...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA, 11, PIO_DIGITAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_11 }, // RX: SERCOM0/PAD[3]
...
//Verton Slave samd21 dev board specific
Uart  SPC_COMS ( &sercom0, 9,  8,   SERCOM_RX_PAD_3, UART_TX_PAD_2 );          // tested recieve
Uart  STARBOARD_COMS ( &sercom2, 3,  2,   SERCOM_RX_PAD_1, UART_TX_PAD_2 );    // tested recieve
Uart  PORT_COMS ( &sercom1, 12,  11,   SERCOM_RX_PAD_3, UART_TX_PAD_0 );       // tested recieve



/**
 * Set up Serial Handler for Serial Port0 (T4<->Samd21 Coms)
 */
...
{
     PORT_COMS.IrqHandler();
}
void SERCOM2_Handler( void )
{
     STARBOARD_COMS.IrqHandler();
}
